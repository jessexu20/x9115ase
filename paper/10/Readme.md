...
Detection of feature interaction has solved various problems in software product line engineering, but many claim that these approaches will work only on specific use cases and cannot be generalized to all kinds of softwares. As a phenomenum, we detect that the activities in feature interaction detection have decreased dramatically after 2012. Therefore we do not suggest a following up work on that.
